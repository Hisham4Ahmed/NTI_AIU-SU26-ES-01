...
#define TCCR1A_Reg   *((voltile uint8_t*)0x4F) 
#define TCCR1B_Reg   *((voltile uint8_t*)0x4E) 

#define TCNT1_Reg    *((voltile uint16_t*)0x4C)
#define TCNT1L_Reg   *((voltile uint8_t*)0x4C) 
#define TCNT1H_Reg   *((voltile uint8_t*)0x4D) 

#define OCR1A_Reg    *((voltile uint16_t*)0x4A) 
#define OCR1AL_Reg   *((voltile uint8_t*)0x4A)  
#define OCR1AH_Reg   *((voltile uint8_t*)0x4B)  

#define OCR1B_Reg    *((voltile uint16_t*)0x48)   
#define OCR1BL_Reg   *((voltile uint8_t*)0x48)   
#define OCR1BH_Reg   *((voltile uint8_t*)0x49)   

#define ICR1_Reg     *((voltile uint16_t*)0x46) 
#define ICR1L_Reg    *((voltile uint8_t*)0x46) 
#define ICR1H_Reg    *((voltile uint8_t*)0x47) 
